...
const std::unordered_map<std::string, Compass> string_to_compass = { {"north", Compass::North}, {"northeast", Compass::North_east}, {"east", Compass::East}, {"southeast", Compass::South_east},
